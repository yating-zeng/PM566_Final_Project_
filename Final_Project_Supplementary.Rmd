...
#### Spplementary table 1.Summary of Percent of people with at least one dose in females grouped by age

```{r}
datatable(vac_Fage_tab)
```

#### Spplementary table 2.Summary of Percent of people with at least one dose in males grouped by age

```{r}
datatable(vac_Mage_tab)
```

#### Spplementary table 3.Summary of Percent of people with at least one dose grouped by sex
...
#### Spplementary table 4.Summary of Percent of people completed a primary series grouped by age

```{r}
datatable(vac_age_tab2)
```

#### Spplementary table 5.Summary of Percent of people completed a primary series in females grouped by age

```{r}
datatable(vac_Fage_tab2)
```

#### Spplementary table 6.Summary of Percent of people completed a primary series in males grouped by age

```{r}
datatable(vac_Mage_tab2)
```

#### Spplementary table 7.Summary of Percent of people completed a primary series grouped by sex
...
#### Spplementary figure 8.Percent of people with at least one dose of females grouped by age

```{r}
ggplotly(Fage1)
```

#### Spplementary figure 9.Percent of people with at least one dose of males grouped by age

```{r}
ggplotly(Mage1)
```

#### Spplementary figure 10.Percent of people with at least one dose grouped by sex
...
#### Spplementary figure 11.Percent of people completed a primary series grouped by age

```{r}
ggplotly(age2)
```

#### Spplementary figure 12.Percent of people completed a primary series of males grouped by age

```{r}
ggplotly(Fage2)
```

#### Spplementary figure 13.Percent of people completed a primary series of males grouped by age

```{r}
ggplotly(Mage2)
```

#### Spplementary figure 14.Percent of people completed a primary seriese grouped by sex in boxplot

```{r}
ggplotly(sex2)
```

#### Spplementary figure 15.Percent of people completed a primary seriese grouped by sex in line plot
...
### Spplementary figure 17.Percent of people completed a primary series grouped by age

```{r}
ggplotly(age4)
```

### Spplementary figure 18.Percent of people completed a primary series grouped by sex

```{r}
ggplotly(Fage4)
```

### Spplementary figure 19.Percent of people completed a primary series of females grouped by age

```{r}
ggplotly(Fage4)
```

### Spplementary figure 20.Percent of people completed a primary series of males grouped by age

---
title: "PM566 Final Project Supplements"
author: "**Yating Zeng**"
date: "`r Sys.Date()`"
output: 
...
Original Report PDF: [**Report**](https://github.com/yating-zeng/PM566_Final_Project/blob/main/Report.pdf)       [[download]](https://github.com/yating-zeng/PM566_Final_Project/raw/main/Report.pdf)
                   ...
                   summarise(
                     ...
                     Records    = sum(!is.na(dose1_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 1.Summary of Percent of people with at least one dose in females") %>% 
                                      kable_styling() 

vac_Mage %>% group_by(cat) %>%
                   summarise(
                     Min    = min(dose1_pct, na.rm = T),
                     Q1     = quantile(dose1_pct, 0.25),
                     Median = median(dose1_pct),
                     ...
                     Records    = sum(!is.na(dose1_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 2.Summary of Percent of people with at least one dose in males") %>% 
                                      kable_styling() 

vac_sex %>% group_by(cat) %>%
                   summarise(
                     Min    = min(dose1_pct, na.rm = T),
                     Q1     = quantile(dose1_pct, 0.25),
                     Median = median(dose1_pct),
                     ...
                     Records    = sum(!is.na(dose1_pct)) 
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 3.Summary of Percent of people with at least one dose") %>% 
                                      kable_styling() 
```
                   ...
                   summarise(
                     ...
                     Records    = sum(!is.na(series_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 4.Summary of Percent of people completed a primary series") %>% 
                                      kable_styling() 
                   ...
                   summarise(
                     ...
                     Records    = sum(!is.na(series_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 5.Summary of Percent of people completed a primary series in females") %>% 
                                      kable_styling() 
                   ...
                   summarise(
                     ...
                     Records    = sum(!is.na(series_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 6.Summary of Percent of people completed a primary series in males") %>% 
                                      kable_styling() 
                   ...
                   summarise(
                     ...
                     Records    = sum(!is.na(series_pct))
                              ...
                              mutate_at(vars(Q1,Median,Q3,Max,Records), funs(round(.,2))) %>% 
                                rename(Group = cat) %>%
                                          kbl(caption = 
             "Supplementary table 7.Summary of Percent of people completed a primary series") %>% 
                                      kable_styling() 
```
...
vac_Fage %>%
    ...
    labs(x = "Age group", y = "Percent of people with at least one dose", fill = 'Age group',
         caption = "Supplementary figure 8.Percent of people with at least one dose of females") 
...
vac_Mage %>%
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1),
          plot.caption = element_text(hjust=0.5, size=rel(1.2))) +
    labs(x = "Age group", y = "Percent of people with at least one dose", fill = 'Age group',
         caption = "Supplementary figure 9.Percent of people with at least one dose of males")
...
vac_sex %>%
    ...
    labs(x = "Sex", y = "Percent of people with at least one dose", fill='Sex group',
         caption = "Supplementary figure 10.Percent of people with at least one dose")
```
...
vac_age %>%
    ...
    labs(x = "Age group", y = "Percent of people completed a primary series", fill = 'Age group',
         caption = "Supplementary figure 11.Percent of people completed a primary series")
...
vac_Fage %>%
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1),
          plot.caption = element_text(hjust=0.5, size=rel(1.2))) +
    labs(x = "Age group", y = "Percent of people completed a primary series", fill = 'Age group',
         caption = "Supplementary figure 12.Percent of people completed a primary series of males")
...
vac_Mage %>%
    ...
    theme(axis.text.x = element_text(angle = 60, hjust = 1),
          plot.caption = element_text(hjust=0.5, size=rel(1.2))) +
    labs(x = "Age group", y = "Percent of people completed a primary series", fill = 'Age group',
         caption = "Supplementary figure 13.Percent of people completed a primary series of males")
...
vac_sex %>%
    ...
    labs(x = "Sex", y = "Percent of people completed a primary seriese", fill = 'Sex group',
         caption = "Supplementary figure 14.Percent of people completed a primary seriese")
...
vac_sex %>%
    ...
    labs(x = "Date(yyyymmdd)", y = "Percent of people with at least one dose", col="Sex group", 
         caption = "Supplementary figure 15.Percent of people completed a primary seriese")
```
...
vac_age %>%
    ...
    labs(x = "Date(yyyymmdd)", y = "Percent of people with at least one dose", col="Age group",
         caption = "Spplementary figure 16.2020-2022 Percent of people with at least one dose")
...
vac_age %>%
    ...
    labs(x = "Date(yyyymmdd)", y = "Percent of people completed a primary series", col="Age group",
         caption = "Spplementary figure 17.2020-2022 Percent of people completed a primary series")
...
vac_sex %>%
    ...
    labs(x = "Date(yyyymmdd)", y = "Percent of people completed a primary series", col="Sex group",
         caption = "Spplementary figure 18.2020-2022 Percent of people completed a primary series")
...
vac_Fage %>%
    ...
    scale_x_discrete(breaks=
          c("20201213","20210601","20211201","20220601","20221019")) +
    labs(x = "Date(yyyymmdd)", y = "Percent of people completed a primary series", col="Age group",
         caption = "Spplementary figure 19.2020-2022 Percent of people completed a primary series of females")
...
vac_Mage %>%
    ...
    scale_x_discrete(breaks=
          c("20201213","20210601","20211201","20220601","20221019")) +
    labs(x = "Date(yyyymmdd)", y = "Percent of people completed a primary series", col="Age group",
         caption = "Spplementary figure 20.Percent of people completed a primary series of males") +

...
sex01 <- vac_sex %>%
    ...
    labs(x = "Date(yyyymmdd)", y = "Percent of people with at least one dose", col="Sex group", 
         title = "Supplemental figure 1.Percent of people completed a primary seriese grouped by sex")
ggplotly(sex01)
```
...
sex02 <- vac_sex %>%
    ...
    theme(plot.caption = element_text(hjust=0.5, size=rel(1.2))) +
    labs(x = "Date(yyyymmdd)", y = "Percent of people with at least one dose", col="Sex group", 
         title = "Supplemental figure 2.Percent of people completed a primary series grouped by sex")
ggplotly(sex02)
```
